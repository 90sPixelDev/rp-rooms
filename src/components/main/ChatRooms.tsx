...
const ChatRooms = () => {
    const styles: Styles = {
        ...
        loading: 'w-[30%] m-auto',
        wrapperROpen:
            'h-[100vh] max-w-[100vw] grid grid-cols-[45px_1fr_minmax(150px,_250px)] grid-rows-[minmax(50%,_85%)_minmax(170px,_20%)] absolute ',
        wrapperLOpen:
            'h-[100vh] max-w-[100vw] grid grid-cols-[250px_1fr_45px] grid-rows-[minmax(50%,_85%)_minmax(170px,_20%)] absolute ',
        wrapperBOpen:
