...
const LeftBarTop = (props: Props) => {
	const styles: Styles = {
		container:
			'flex flex-col gap-4 border-purple-100 bg-purple-300 rounded-br-lg transition',
		...
		icon: '',
		arrBtnOpen:
			'bg-purple-400 h-full w-full border-2 border-purple-600 hover:bg-purple-600 transition',
		arrBtnClose:
			'bg-purple-200 px-2 h-full w-full border-2 border-purple-400 hover:bg-purple-600 transition',
